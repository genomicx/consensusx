/* @ts-self-types="./sparrowhawk.d.ts" */
...
export class AssemblyHelper {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(AssemblyHelper.prototype);
        obj.__wbg_ptr = ptr;
        AssemblyHelperFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        AssemblyHelperFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_assemblyhelper_free(ptr, 0);
    }
    /**
     * Assemble method of the wasm version
     * @param {boolean} no_bubble_collapse
     * @param {boolean} no_dead_end_removal
     */
    assemble(no_bubble_collapse, no_dead_end_removal) {
        wasm.assemblyhelper_assemble(this.__wbg_ptr, no_bubble_collapse, no_dead_end_removal);
    }
    /**
    ...
    get_assembly() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.assemblyhelper_get_assembly(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
    ...
    get_preprocessing_info() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.assemblyhelper_get_preprocessing_info(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     * @param {boolean} do_bloom
     * @param {boolean} do_fit
     * @returns {AssemblyHelper}
     */
    static new(file1, file2, k, verbose, min_count, min_qual, chunk_size, do_bloom, do_fit) {
        const ret = wasm.assemblyhelper_new(file1, file2, k, verbose, min_count, min_qual, chunk_size, do_bloom, do_fit);
        return AssemblyHelper.__wrap(ret);
    }
}
if (Symbol.dispose) AssemblyHelper.prototype[Symbol.dispose] = AssemblyHelper.prototype.free;
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_log_4e65efd3f1bf7b25: function(arg0, arg1) {
        ...
        __wbg_new_c3b006de12a23646: function() { return handleError(function () {
        ...
        __wbg_readAsArrayBuffer_b52888f004304a90: function() { return handleError(function (arg0, arg1) {
    ...
    return {
        __proto__: null,
        "./sparrowhawk_bg.js": import0,
    };
}

const AssemblyHelperFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_assemblyhelper_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('sparrowhawk_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
